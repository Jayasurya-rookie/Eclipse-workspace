/*
 * DISPLAY EVEN ELEMENTS PRESENT IN THE MATRIX
 */
...
public class evenElements {
	...
	public static void main(String[] args) {
		...
		System.out.println("The even elements in 1st Matrix are: ");
		for(int i=0; i<a.length;i++) {
		...
		System.out.println("The even elements in 2nd Matrix are: ");
		for(int i=0; i<a.length;i++) {
			for(int j=0;j<a.length;j++) {
				if(a1[i][j]%2==0) {
